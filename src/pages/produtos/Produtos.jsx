    ...
    <>
      ...
      <main className={styles.produtos}>
        ...
        <div className={styles.produto}>
          <div className={styles.produto_img} style={{ backgroundImage: `url('https://a-static.mlcdn.com.br/800x560/kit-2-cadeiras-reforcadas-estofadas-mesa-cozinha-luxo-linho-balaqui-decor/balaquiestofadosltda/15883002572/0c8eed182060d51829a03c5bb1b0e7b8.jpeg')` }}></div>
